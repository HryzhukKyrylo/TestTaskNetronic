 ...
 * Use the [UsersScreenFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class UsersScreenFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment UsersScreenFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            UsersScreenFragment().apply {
